...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/muhil28/terraform-provider-rancher2
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-rancher2_6.0.0
